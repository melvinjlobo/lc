...
class Solution {
    ...
    //             System.out.println("In the loop for non - digits");
    //             if(operand == '+') {
    //                 result += lastNumber;
    //                 System.out.println("Operand +, result - " + result + ", lastNumber = 0");
    //                 lastNumber = currentNumber;
    //             }else if( operand == '-') {
    //                 result += -lastNumber;
    //                 System.out.println("Operand -, result - " + result + ", lastNumber = 0");
    ...
    //             else if( operand == '*') {
    //                 result *= lastNumber;
    //                 System.out.println("Operand *, result - " + result + ", lastNumber = " + lastNumber);
    //             } else if( operand == '/') {
    //                 result /= lastNumber;
    //                 System.out.println("Operand /, result - " + result + ", lastNumber = " + lastNumber);
    //             }
    ...
    //             operand = c;
    //             System.out.println("Operand switched to - " + operand);
    //         }
